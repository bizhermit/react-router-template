...
function PartSelectBox({
  ...
  if (props.coreMode === "hidden" || splitMode === "hidden") state = "hidden";
  else if (props.coreMode === "disabled" || splitMode === "disabled") state = "disabled";
  else if (props.coreMode === "readonly" || splitMode === "readonly") state = "readonly";
